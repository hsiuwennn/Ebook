  ...
  return (
    ...
    /******/
    {
      ...
      function _(module, __webpack_exports__, __webpack_require__) {
        ...
        /*#__PURE__*/
        __webpack_require__.n(external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_); // CONCATENATED MODULE: ./src/js/base/summernote-en-US.js
        ...
        function () {
          ...
          function Context_Context($note, options) {
            _classCallCheck2(this, Context_Context);
        ...
        function () {
          function range_WrappedRange(sc, so, ec, eo) {
            _classCallCheck2(this, range_WrappedRange);
          ...
          _createClass2(range_WrappedRange, [{
            key: "nativeRange",
        ...
        function () {
          function History_History($editable) {
            _classCallCheck2(this, History_History);
        ...
        function () {
          function Style_Style() {
            _classCallCheck2(this, Style_Style);
          }

          _createClass2(Style_Style, [{
            key: "jQueryCSS",
        ...
        function () {
          function Bullet_Bullet() {
            _classCallCheck2(this, Bullet_Bullet);
          }

          _createClass2(Bullet_Bullet, [{
        ...
        function () {
          function Typing_Typing(context) {
            _classCallCheck2(this, Typing_Typing);
        ...
        */
        ...
        function () {
          function Table_Table() {
            _classCallCheck2(this, Table_Table);
          }

          _createClass2(Table_Table, [{
            key: "tab",
        ...
        function () {
          function Editor_Editor(context) {
            ...
            _classCallCheck2(this, Editor_Editor);
        ...
        function () {
          function Clipboard_Clipboard(context) {
            _classCallCheck2(this, Clipboard_Clipboard);

            this.context = context;
            this.$editable = context.layoutInfo.editable;
          }

          _createClass2(Clipboard_Clipboard, [{
            key: "initialize",
            value: function initialize() {
        ...
        function () {
          function Dropzone_Dropzone(context) {
            _classCallCheck2(this, Dropzone_Dropzone);
          ...
          _createClass2(Dropzone_Dropzone, [{
            key: "initialize",
            value: function initialize() {
        ...
        function () {
          function Codeview_CodeView(context) {
            _classCallCheck2(this, Codeview_CodeView);
          ...
          _createClass2(Codeview_CodeView, [{
            key: "sync",
            value: function sync() {
        ...
        function () {
          function Statusbar_Statusbar(context) {
            _classCallCheck2(this, Statusbar_Statusbar);
          ...
          _createClass2(Statusbar_Statusbar, [{
            key: "initialize",
            value: function initialize() {
              var _this16 = this;
        ...
        function () {
          function Fullscreen_Fullscreen(context) {
            ...
            _classCallCheck2(this, Fullscreen_Fullscreen);
          ...
          _createClass2(Fullscreen_Fullscreen, [{
            key: "resizeTo",
        ...
        function () {
          function Handle_Handle(context) {
            ...
            _classCallCheck2(this, Handle_Handle);
        ...
        function () {
          function AutoLink_AutoLink(context) {
            ...
            _classCallCheck2(this, AutoLink_AutoLink);
          ...
          _createClass2(AutoLink_AutoLink, [{
            key: "initialize",
            value: function initialize() {
        ...
        function () {
          function AutoSync_AutoSync(context) {
            ...
            _classCallCheck2(this, AutoSync_AutoSync);
          ...
          _createClass2(AutoSync_AutoSync, [{
        ...
        function () {
          function AutoReplace_AutoReplace(context) {
            ...
            _classCallCheck2(this, AutoReplace_AutoReplace);
          ...
          _createClass2(AutoReplace_AutoReplace, [{
            key: "shouldInitialize",
            value: function shouldInitialize() {
            ...
            value: function replace() {
              ...
              this.options.match(keyword, function (match) {
                if (match) {
                  ...
                  } else if (_instanceof2(match, jQuery)) {
                    node = match[0];
                  } else if (_instanceof2(match, Node)) {
                    node = match;
                  }
        ...
        function () {
          function Placeholder_Placeholder(context) {
            ...
            _classCallCheck2(this, Placeholder_Placeholder);
          ...
          _createClass2(Placeholder_Placeholder, [{
            key: "shouldInitialize",
            value: function shouldInitialize() {
        ...
        function () {
          function Buttons_Buttons(context) {
            _classCallCheck2(this, Buttons_Buttons);
        ...
        function () {
          function Toolbar_Toolbar(context) {
            _classCallCheck2(this, Toolbar_Toolbar);
        ...
        function () {
          function LinkDialog_LinkDialog(context) {
            _classCallCheck2(this, LinkDialog_LinkDialog);
          ...
          _createClass2(LinkDialog_LinkDialog, [{
            key: "initialize",
            value: function initialize() {
        ...
        function () {
          function LinkPopover_LinkPopover(context) {
            ...
            _classCallCheck2(this, LinkPopover_LinkPopover);
          ...
          _createClass2(LinkPopover_LinkPopover, [{
            key: "shouldInitialize",
            value: function shouldInitialize() {
        ...
        function () {
          function ImageDialog_ImageDialog(context) {
            _classCallCheck2(this, ImageDialog_ImageDialog);
          ...
          _createClass2(ImageDialog_ImageDialog, [{
            key: "initialize",
            value: function initialize() {
              var imageLimitation = '';
        ...
        function () {
          function ImagePopover_ImagePopover(context) {
            ...
            _classCallCheck2(this, ImagePopover_ImagePopover);
          ...
          _createClass2(ImagePopover_ImagePopover, [{
            key: "shouldInitialize",
            value: function shouldInitialize() {
        ...
        function () {
          function TablePopover_TablePopover(context) {
            ...
            _classCallCheck2(this, TablePopover_TablePopover);
          ...
          _createClass2(TablePopover_TablePopover, [{
            key: "shouldInitialize",
            value: function shouldInitialize() {
        ...
        function () {
          function VideoDialog_VideoDialog(context) {
            _classCallCheck2(this, VideoDialog_VideoDialog);
          ...
          _createClass2(VideoDialog_VideoDialog, [{
            key: "initialize",
            value: function initialize() {
              var $container = this.options.dialogsInBody ? this.$body : this.options.container;
        ...
        function () {
          function HelpDialog_HelpDialog(context) {
            _classCallCheck2(this, HelpDialog_HelpDialog);
          ...
          _createClass2(HelpDialog_HelpDialog, [{
            key: "initialize",
            value: function initialize() {
              var $container = this.options.dialogsInBody ? this.$body : this.options.container;
        ...
        function () {
          function AirPopover_AirPopover(context) {
            ...
            _classCallCheck2(this, AirPopover_AirPopover);
          ...
          _createClass2(AirPopover_AirPopover, [{
            key: "shouldInitialize",
            value: function shouldInitialize() {
        ...
        function () {
          function HintPopover_HintPopover(context) {
            ...
            _classCallCheck2(this, HintPopover_HintPopover);
          ...
          _createClass2(HintPopover_HintPopover, [{
            key: "shouldInitialize",
            value: function shouldInitialize() {
      ...
      function _(module, __webpack_exports__, __webpack_require__) {
        ...
        var external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default =
        /*#__PURE__*/
        __webpack_require__.n(external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_); // EXTERNAL MODULE: ./src/js/base/renderer.js
        ...
        /* default */
        ].create('<div class="note-toolbar card-header" role="toolbar"></div>');
        ...
        /* default */
        ].create(['<output class="note-status-output" role="status" aria-live="polite"/>', '<div class="note-statusbar" role="status">', '<output class="note-status-output" aria-live="polite"></output>', '<div class="note-resizebar" aria-label="Resize">', '<div class="note-icon-bar"/>', '<div class="note-icon-bar"/>', '<div class="note-icon-bar"/>', '</div>', '</div>'].join(''));
        ...
        /* default */
          ...
          var markup = Array.isArray(options.items) ? options.items.map(function (item) {
            ...
            var option = _typeof2(item) === 'object' ? item.option : undefined;
        ...
        /* default */
        ].create(['<div class="note-popover popover in">', '<div class="arrow"/>', '<div class="popover-content note-children-container"/>', '</div>'].join(''), function ($node, options) {
        ...
        var bs4_ui = ui; // EXTERNAL MODULE: ./src/js/base/settings.js + 37 modules
